      ...
      <section className="workspace">
        <header className="workspace-header">
          ...
          <div className="workspace-meta">
            <span>{svgMeta.isValid ? 'Корректный SVG' : 'Ошибка'}</span>
            <span>{svgMeta.isValid ? `${svgMeta.shapes} элементов` : '—'}</span>
        ...
        <article className="panel panel-editor">
          <div className="panel-header">
            <div>
              ...
              <h2>{editorMode === 'code' ? 'SVG код' : 'AI запрос'}</h2>
            </div>
            ...
            <div className="editor-actions">
              ...
              <div className="mode-switch" aria-label="Режим редактора">
                <button
                  type="button"
